...
- **Structured blocks** — the script is built from four block types:
  ...
  - 💬 **Dialogue** — tap to pick the speaker (scene cast shown first), add V.O./O.S. extensions and parentheticals. New characters can be created inline without leaving the script.
...
- **Export / import**
  ...
  - **Fountain (`.fountain`)** — the open plain-text screenplay standard, readable by Final Draft, Highland, Fade In, and others.
